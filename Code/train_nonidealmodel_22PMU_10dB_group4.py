...
# model path name
autoencoder_path = 'NonIdeal_Models/1/train_22PMU_10dB_autoencoder_group4_3.hdf5'
model_path = 'NonIdeal_Models/1/train_22PMU_10dB_fullmodel_group4_3.hdf5'


DATA_DIR_TRAIN = os.getcwd() + "/Validation/AE_Train&Test/CNN_22PMU_10dB/Train/"
DATA_DIR_TEST = os.getcwd() + "/Validation/AE_Train&Test/CNN_22PMU_10dB/Test/"
DATA_DIR_VAL = os.getcwd() + "/Validation/AE_Train&Test/CNN_22PMU_10dB/Val/"
...
plt.savefig('NonIdeal_Models/1/Autoencoder_Test_22PMU_10dB')
plt.show()
...
plt.legend()
plt.savefig('NonIdeal_Models/1/Autoencoder_Loss_22PMU_10dB')
plt.show()
...
plt.grid(b = True, which = 'both')
plt.legend()
plt.savefig('NonIdeal_Models/1/FullModel_Loss_22PMU_10dB')
plt.show()
...
plt.grid(b = True, which = 'both')
plt.legend()
plt.savefig('NonIdeal_Models/1/FullModel_Accuracy_22PMU_10dB')
plt.show()
...
plt.savefig('NonIdeal_Models/1/FullModel_Correctly_Labeled_22PMU_10dB')
plt.show()
...
plt.savefig('NonIdeal_Models/1/FullModel_Incorrectly_Labeled_22PMU_10dB')
plt.show()
